...
- ArcView 3.x Attribute Index - no longer used by ArcGIS (x.atx): ex. counties.atx
  MIME Types (https://www.iana.org/assignments/media-types/media-types.xhtml)   - application/octet-stream (main file)
- application/dbf
- application/dbase
- application/vnd.shx
- application/vnd.shp
