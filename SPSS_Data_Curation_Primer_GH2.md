...
2. **Data Level Metadata**
  ...
  a. The IBM SPSS Statistics software can create embedded documentation for the dataset. Data files in the software contain embedded metadata that describes and defines the data in the file. This data level metadatacan be exported.

  b. The most important metadata for SPSS data includes:
  ...
  3. A **codebook**, or a **data dictionary** can be created from an SPSS data file.
