...
Documentation Tools |<li>[Colectica](https://colectica.com/software/colecticaforexcel/)</li><li>[Cornell README template](https://cornell.app.box.com/v/ReadmeTemplate)</li><ul><li>README files should be written in plain-text (.txt) or markdown (.md) for accessibility; [Markdown Guide](https://www.markdownguide.org/basic-syntax/)</ul></li><li>[Jupyter](https://jupyter.org/)</li>
